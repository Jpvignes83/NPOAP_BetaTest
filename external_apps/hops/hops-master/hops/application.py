...
class HOPS(MainWindow):
    ...
    def __init__(self, embedded=False, host_root=None, host_frame=None, on_embedded_close=None):
        ...
        self._on_embedded_close = on_embedded_close if embedded else None  # NPOAP: embedded close callback
        ...
        self.log.runtime('HOPS initialized (embedded={0})'.format(bool(embedded)))
    ...
    def open_my_profile(self):
        self.log.runtime('Action: open_my_profile')
    ...
    def select_data_target(self):
        self.log.runtime('Action: select_data_target')
        ...
        try:
            ...
            self.log.runtime_exception('Error in select_data_target', e)
            print('\nData & Target failed:')
            traceback.print_exc()
            print()
    ...
    def run_reduction(self):
        self.log.runtime('Action: run_reduction')
        ...
        try:
            ...
            self.log.runtime_exception('Error in run_reduction', e)
            print('\nReduction failed:')
            traceback.print_exc()
            print()
    ...
    def inspect_frames(self):
        self.log.runtime('Action: inspect_frames')
        ...
        try:
            ...
            self.log.runtime_exception('Error in inspect_frames', e)
            print('\nInspection failed:')
            traceback.print_exc()
            print()
    ...
    def run_alignment(self):
        self.log.runtime('Action: run_alignment')
        ...
        try:
            ...
            self.log.runtime_exception('Error in run_alignment', e)
            print('\nAlignment failed:')
            traceback.print_exc()
            print()
    ...
    def photometry(self):
        self.log.runtime('Action: photometry')
        ...
        try:
            ...
            self.log.runtime_exception('Error in photometry', e)
            print('\nPhotometry failed:')
            traceback.print_exc()
            print()
    ...
    def run_photometry(self):
        self.log.runtime('Action: run_photometry')
        ...
        try:
            ...
            self.log.runtime_exception('Error in run_photometry', e)
    ...
    def fitting(self):
        self.log.runtime('Action: fitting')
        ...
        try:
            ...
            self.log.runtime_exception('Error in fitting', e)
            print('\nFitting failed:')
            traceback.print_exc()
            print()
    ...
    def open_observing_planner(self):
        self.log.runtime('Action: open_observing_planner')
        ...
        try:
            ...
            self.log.runtime_exception('Error in open_observing_planner', e)
