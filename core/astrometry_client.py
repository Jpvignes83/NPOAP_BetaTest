...
class Client(object):
    ...
    def download_wcs(self, job_id, dest_path):
        """
        Télécharge le fichier WCS FITS résultant pour un job donné
        ...
        if response.status_code == 200:
            ...
            raise Exception(f"Échec HTTP {response.status_code} pour le téléchargement du WCS.")
